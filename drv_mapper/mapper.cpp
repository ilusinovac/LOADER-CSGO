#include "mapper.hpp"
uint64_t mapper::MapDriver(HANDLE iqvw64e_device_handle, const uint8_t* driver_file, size_t size)
{
	...
	do
	{
		...
		//[+] Image base has been allocated at 0x << reinterpret_cast<void*>(kernel_image_base)
		...
		//[<] Calling DriverEntry 0x reinterpret_cast<void*>(address_of_entry_point)
